/* ─── video-scroll-hero — script4_clean.js ─── */
/* IntersectionObserver atualizado: seção #step-3 foi removida,
   observer agora monitora apenas #step-1, #step-2 e #step-4     */
(function () {
  'use strict';
  ...
  // Observer atualizado — #step-3 foi removido do HTML
  ...
  // Apenas as seções que existem no HTML limpo
  ['step-1', 'step-2', 'step-4'].forEach((id) => {
